  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <DatePicker
          label="From date"
          date={search.fromDate ? parseISO(search.fromDate) : undefined}
          onChange={(d) => setSearch({ fromDate: d ? format(d, "yyyy-MM-dd") : undefined })}
        />
        <DatePicker
          label="To date"
          date={search.toDate ? parseISO(search.toDate) : undefined}
          onChange={(d) => setSearch({ toDate: d ? format(d, "yyyy-MM-dd") : undefined })}
        />
      </div>
